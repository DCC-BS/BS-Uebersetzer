...
from llm_translate import chunk_and_translate, eval_translation
...
def main(input_file: str):
    ...
    llm = 'llama3.1:70b'
    translated_text = chunk_and_translate(original_text, target_language="German", llm=llm, max_tokens=6000, overlap=200)
    if translated_text:
